/*!
 * jQuery Bootgrid Extended v1.0.0 - 09/09/2016
 * This is an extended and modified version of jQuery Bootgrid v1.3.1
 *
 * Copyright (c) 2014-2015 Rafael Staib (http://www.jquery-bootgrid.com)
 * Copyright (c) 2016 John Lioneil Dionisio
...
;(function ($, window, undefined)
{
	...
	*/
	...
	Grid.defaults = {
		 ...
		 **/
		css: {
			actions: "actions form-group btn-group m-l-1-sm-up", // must be a unique class name or constellation of class names within the header and footer
			center: "text-center",
			...
			icon: "icon fa",
			iconColumns: "fa-th",
			iconDown: "ion-ios-arrow-down",
			iconRefresh: "ion-ios-refresh",
			iconSearch: "fa-search",
			iconUp: "ion-ios-arrow-up",
			infos: "infos", // must be a unique class name or constellation of class names within the header and footer,
			left: "text-left",
			pagination: "pagination", // must be a unique class name or constellation of class names within the header and footer
			paginationItem: "page-item",
			paginationButton: "page-link button", // must be a unique class name or constellation of class names within the pagination
			...
			right: "text-xs-right",
			search: "search form-group pull-xs-left", // must be a unique class name or constellation of class names within the header and footer
		...
		labels: {
			...
			loading: "<i class=\"fa fa-spin fa-pulse\"></i>",
			noResults: "<div class=\"text-xs-center text-muted\"><i class=\"fa fa-info-circle\">&nbsp;</i>No records found</div>",
			refresh: "Refresh",
			search: "Search"
		},
		...
		templates: {
			...
			actionDropDownItem: "<li class=\"dropdown-item\"><a data-action=\"{{ctx.action}}\" class=\"{{css.dropDownItemButton}}\">{{ctx.text}}</a></li>",
			actionDropDownCheckboxItem: "<li class=\"{{css.dropDownItem}}\"><label class=\"{{css.dropDownItem}} checkbox\"><input name=\"{{ctx.name}}\" type=\"checkbox\" value=\"1\" class=\"{{css.dropDownItemCheckbox}}\" {{ctx.checked}} /> <span>{{ctx.label}}</span></label></li>",
			actions: "<div class=\"{{css.actions}}\"></div>",
			body: "<tbody></tbody>",
			cell: "<td class=\"{{ctx.css}}\" style=\"{{ctx.style}}\">{{ctx.content}}</td>",
			footer: "<div id=\"{{ctx.id}}\" class=\"{{css.footer}}\"><div class=\"row\"><div class=\"col-sm-6\"><p class=\"{{css.pagination}}\"></p></div><div class=\"col-sm-6 infoBar text-xs-center text-sm-right\"><div class=\"{{css.infos}}\"></div></div></div></div>",
			header: "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row\"><div class=\"col-sm-12 actionBar\"><p class=\"{{css.search}}\"></p><p class=\"{{css.actions}}\"></p></div></div></div>",
			headerCell: "<th data-column-id=\"{{ctx.column.id}}\" class=\"{{ctx.css}}\" style=\"{{ctx.style}}\"><a href=\"javascript:void(0);\" class=\"{{css.columnHeaderAnchor}} {{ctx.sortable}}\"><span class=\"{{css.columnHeaderText}}\">{{ctx.column.text}}</span>{{ctx.icon}}</a></th>",
			icon: "<span class=\"{{css.icon}} {{ctx.iconCss}}\"></span>",
			infos: "<small class=\"{{css.infos}}\">{{lbl.infos}}</small>",
			loading: "<tr><td colspan=\"{{ctx.columns}}\" class=\"loading\">{{lbl.loading}}</td></tr>",
			noResults: "<tr><td colspan=\"{{ctx.columns}}\" class=\"no-results\">{{lbl.noResults}}</td></tr>",
			pagination: "<ul class=\"{{css.pagination}} pagination-xs-center\"></ul>",
			paginationItem: "<li class=\"{{css.paginationItem}} {{ctx.css}}\"><a data-page=\"{{ctx.page}}\" class=\"{{css.paginationButton}}\">{{ctx.text}}</a></li>",
			rawHeaderCell: "<th class=\"{{ctx.css}}\">{{ctx.content}}</th>", // Used for the multi select box
			row: "<tr{{ctx.attr}}>{{ctx.cells}}</tr>",
			search: "<div class=\"{{css.search}}\"><div class=\"input-group\"><label class=\"input-group-icon-addon\" for=\"bootgrid{{css.searchID}}\"><i class=\"{{css.icon}} {{css.iconSearch}}\"></i></label><input id=\"bootgrid{{css.searchID}}\" type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /></div></div>",
...
//# sourceMappingURL=jquery-bootgrid.modified.min.js.map
