            ...
            <div class="row">
                <div class="col-md-6 col-xs-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="" action="{{ action('\Modules\Type\TypeController@update', $resource->id) }}" method="POST">
                            {!! method_field('PUT') !!}
                            {{ csrf_field() }}
                            <div class="box-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Type Name" value="{{ null !== old('name') ? old('name') : $resource->name }}">
